...
export const PERMISSION_GROUPS = {
  ...
  MARKETING_MANAGER: [
    ...
    PERMISSIONS.SMS_CAMPAIGNS_READ,
    PERMISSIONS.SMS_CAMPAIGNS_CREATE,
    PERMISSIONS.SMS_CAMPAIGNS_CONTROL,
    PERMISSIONS.SMS_CAMPAIGNS_EXPORT,
...
export const MENU_PERMISSIONS = {
  ...
  'sms-campaigns': [PERMISSIONS.SMS_CAMPAIGNS_READ, PERMISSIONS.ADMIN_ACCESS],
  ...
  backups: [PERMISSIONS.ADMIN_ACCESS],
