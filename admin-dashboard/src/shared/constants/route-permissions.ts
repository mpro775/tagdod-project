...
export const ROUTE_PERMISSIONS = {
  ...
  // Commissions
  '/commissions/reports': [PERMISSIONS.ANALYTICS_READ, PERMISSIONS.ADMIN_ACCESS],
  '/commissions/statements/:engineerId': [PERMISSIONS.ANALYTICS_READ, PERMISSIONS.ADMIN_ACCESS],
  ...
  '/system/error-logs': [PERMISSIONS.SYSTEM_LOGS, PERMISSIONS.ADMIN_ACCESS],
  '/system/settings': [PERMISSIONS.SETTINGS_READ, PERMISSIONS.ADMIN_ACCESS],
  '/system/backups': [PERMISSIONS.ADMIN_ACCESS],
  ...
  '/admin/addresses': [PERMISSIONS.ADDRESSES_READ, PERMISSIONS.ADMIN_ACCESS],
  '/admin/favorites': [PERMISSIONS.FAVORITES_READ, PERMISSIONS.ADMIN_ACCESS],
} as const;
