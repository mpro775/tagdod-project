...
export const ROUTE_PERMISSIONS = {
  ...
  // Website Content
  '/website/landing-settings': [PERMISSIONS.LANDING_SETTINGS_READ, PERMISSIONS.ADMIN_ACCESS],
  '/website/projects': [PERMISSIONS.PROJECTS_READ, PERMISSIONS.ADMIN_ACCESS],
  '/website/projects/new': [PERMISSIONS.PROJECTS_CREATE, PERMISSIONS.ADMIN_ACCESS],
  '/website/projects/:id': [PERMISSIONS.PROJECTS_UPDATE, PERMISSIONS.ADMIN_ACCESS],
  '/website/articles': [PERMISSIONS.ARTICLES_READ, PERMISSIONS.ADMIN_ACCESS],
  '/website/articles/new': [PERMISSIONS.ARTICLES_CREATE, PERMISSIONS.ADMIN_ACCESS],
  '/website/articles/:id': [PERMISSIONS.ARTICLES_UPDATE, PERMISSIONS.ADMIN_ACCESS],
  '/website/landing-products': [PERMISSIONS.LANDING_PRODUCTS_READ, PERMISSIONS.ADMIN_ACCESS],
  '/website/landing-brands': [PERMISSIONS.LANDING_BRANDS_READ, PERMISSIONS.ADMIN_ACCESS],
  '/website/contact-requests': [PERMISSIONS.CONTACT_REQUESTS_READ, PERMISSIONS.ADMIN_ACCESS],
  '/website/contact-requests/:id': [PERMISSIONS.CONTACT_REQUESTS_UPDATE, PERMISSIONS.ADMIN_ACCESS],
} as const;
