  ...
  const handleGenerateReport = async () => {
    try {
      await generateReport.mutateAsync({
        ...
        generateCharts: reportForm.includeCharts,
      });
            ...
            <Card>
              <CardContent sx={{ p: cardPadding }}>
                ...
                {advancedReports.isLoading ? (
                  ...
                  <List sx={{ p: 0 }}>
                    {Array.isArray(advancedReports.data?.data) &&
                        ...
                        >
                          ...
                          >
                            <Stack
                              ...
                              sx={{
                                flexWrap: 'wrap',
                                justifyContent: breakpoint.isXs ? 'flex-start' : 'flex-end',
                              }}
                            >
