    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent dividers>
        <Grid container spacing={2}>
          ...
          <Grid size={{ xs: 12, md: 6 }}><TextField fullWidth label={t('form.coverImage')} value={formData.coverImage} onChange={(e) => handleChange('coverImage', e.target.value)} margin="normal" placeholder="https://..." /></Grid>
          <Grid size={{ xs: 12, md: 6 }}><TextField fullWidth label={t('form.city')} value={formData.city} onChange={(e) => handleChange('city', e.target.value)} margin="normal" /></Grid>
          <Grid size={{ xs: 12, md: 6 }}><TextField fullWidth label={t('form.startDate')} type="date" value={formData.startDate} onChange={(e) => handleChange('startDate', e.target.value)} margin="normal" InputLabelProps={{ shrink: true }} /></Grid>
          <Grid size={{ xs: 12, md: 6 }}><TextField fullWidth label={t('form.endDate')} type="date" value={formData.endDate} onChange={(e) => handleChange('endDate', e.target.value)} margin="normal" InputLabelProps={{ shrink: true }} /></Grid>
          <Grid size={{ xs: 12 }}>
          ...
          <Grid size={{ xs: 12, md: 4 }}><TextField fullWidth type="number" label={t('form.landingOrder')} value={formData.landingOrder} onChange={(e) => handleChange('landingOrder', parseInt(e.target.value) || 0)} margin="normal" /></Grid>
        </Grid>
      </DialogContent>
      <DialogActions>
