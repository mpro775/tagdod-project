...
ميزة إدارة السلة توفر نظام شامل لإدارة وعرض جميع سلال التسوق في النظام، مع إمكانيات متقدمة لتتبع السلال المتروكة وإرسال التذكيرات وتحليل الأداء.
...
### 2. المكونات
- **CartStatsCard**: بطاقة عرض الإحصائيات
...
2. **التذكير الثاني**: بعد 24 ساعة (فقط إذا تم إرسال الأول)
