...
export class User {
  ...
  @Prop({ type: String, enum: Object.values(AcquisitionChannel), default: AcquisitionChannel.ORGANIC })
  acquisitionChannel!: AcquisitionChannel;

  @Prop({ type: Types.ObjectId, ref: 'User', index: true, default: null })
  createdByMarketerId?: Types.ObjectId | null;

  @Prop({ type: Date, default: null })
  marketerCreatedAt?: Date | null;
...
UserSchema.index({ createdByMarketerId: 1, createdAt: -1 });
UserSchema.index({ acquisitionChannel: 1, createdAt: -1 });
