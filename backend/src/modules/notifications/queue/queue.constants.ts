// Queue names - exported from a separate file to avoid circular dependencies
...
// Bulk queue for long-running batch send operations
export const NOTIFICATION_BULK_QUEUE = 'notification-bulk';
