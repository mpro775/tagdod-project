      ...
      {showSuccess ? (
        <div className="p-6 flex flex-col items-center justify-center min-h-[50vh]">
          ...
          <p className="text-tagadod-gray text-center mb-8">
            {t('orderNewEngineer.successMessage', 'سيتم إعلامك عند تلقي عروض من المهندسين')}
          </p>
          <GlobalButton
            fullWidth={false}
        ...
        >
          ...
          <GlobalTextField
            ...
            placeholder={t('orderNewEngineer.requestTitleHint', 'مثال: صيانة تكييف')}
            value={title}
          ...
          <GlobalTextField
            ...
            placeholder={t('orderNewEngineer.descriptionHint', 'اشرح المشكلة بالتفصيل...')}
            value={description}
