...
graph TB
    ...
    subgraph Application["🏢 تطبيقات تاجا دودو"]
        ...
        subgraph WebLayer["طبقة الويب"]
            AdminPanel["💻 Admin Panel<br/>React + TypeScript<br/>Material-UI<br/><br/>• لوحة تحكم كاملة<br/>• إدارة المنتجات<br/>• التحليلات<br/>• RTL Support"]
            
            CustomerWeb["🌐 موقع العملاء<br/>React + TypeScript<br/>(مستقبلاً)<br/><br/>• واجهة للعملاء<br/>• تصفح وشراء<br/>• PWA"]
        end
