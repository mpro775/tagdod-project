...
13. [**خدمة التسعير (Pricing)**](./13-pricing-service.md)
    - حساب الأسعار
    - العروض والخصومات

14. [**خدمة الإشعارات (Notifications)**](./14-notifications-service.md)
    - قائمة الإشعارات
    - تسجيل الأجهزة للإشعارات

15. [**خدمة الطلبات الهندسية (Services)**](./15-services-service.md)
    - إنشاء طلب خدمة
    - قبول العروض
    - التقييم
