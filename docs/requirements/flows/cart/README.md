...
- **الكوبونات اليدوية المتعددة:**
  - دعم **تطبيق عدة كوبونات يدوياً** في نفس السلة
  - تطبيق الكوبونات **تراكمياً** - كل كوبون يُحسب على المبلغ المتبقي بعد الكوبونات السابقة
  - منع تطبيق نفس الكوبون مرتين
  - عرض تفصيلي لجميع الكوبونات المطبقة مع خصم كل كوبون
- **الكوبونات التلقائية:** تطبيق كوبونات تلقائية
- **العروض الترويجية:** تطبيق عروض ترويجية على المنتجات
- **الخصومات التلقائية:** خصومات حسب نوع الحساب (تاجر/مهندس/عميل)
...
- **الكوبونات المتعددة:**
  - `appliedCouponCodes`: مصفوفة أكواد الكوبونات المطبقة يدوياً (string[])
...
- `pricingSummary`: ملخص الأسعار (object)
  ...
  - `itemsDiscount`: خصم المنتجات (من العروض الترويجية)
  - `promotionDiscount`: خصم العروض (للتوافق)
  - `couponDiscount`: إجمالي خصم الكوبونات (تراكمي)
  - `autoDiscount`: الخصم التلقائي
  - `totalDiscount`: إجمالي الخصم (itemsDiscount + couponDiscount + autoDiscount)
...
- **الكوبونات:**
  - **دعم كوبونات متعددة:** يمكن تطبيق عدة كوبونات يدوياً في نفس السلة
  - **تطبيق تراكمي:** كل كوبون يُحسب على المبلغ المتبقي بعد الكوبونات السابقة
  - **منع التكرار:** لا يمكن تطبيق نفس الكوبون مرتين
  - **عرض تفصيلي:** عرض جميع الكوبونات المطبقة مع خصم كل كوبون
  - **كوبونات تلقائية:** دعم كوبونات مطبقة تلقائياً
- **الخصومات:**
  - **خصم المنتجات:** من العروض الترويجية (itemsDiscount)
  - **خصم الكوبونات:** تراكمي من الكوبونات المطبقة
  - **خصم حسب نوع الحساب:** تاجر/مهندس/عميل (autoDiscount)
