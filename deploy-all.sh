...
echo ""
echo "🔐 Access Nginx Proxy Manager Dashboard:"
echo "  URL: http://$(hostname -I | awk '{print $1}'):81"
echo "  Default Login:"
echo "    Email: admin@example.com"
echo "    Password: changeme"
echo "  ⚠️  You will be prompted to change these credentials on first login"
echo ""
echo "🌐 Configure your domains in Nginx Proxy Manager:"
echo "  1. Add Proxy Host for API:"
echo "     - Domain: api.allawzi.net"
...
echo "  - View NPM logs: docker-compose logs -f nginx-proxy-manager"
...
echo ""
echo "📝 Next steps:"
echo "  1. Access Nginx Proxy Manager at http://YOUR_IP:81"
echo "  2. Change default credentials"
echo "  3. Add Proxy Hosts for your domains"
echo "  4. Request SSL certificates from Let's Encrypt"
echo "  5. Test all endpoints thoroughly"
echo ""
echo -e "${YELLOW}⚠️  Make sure ports 80, 443, and 81 are open in your firewall!${NC}"